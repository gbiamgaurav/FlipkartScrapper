...
class MongoDBManagement:
    ...
    def __init__(self, username, password):
        ...
        """
        try:
            self.username = "Project"
            self.password = "Kabali123$"
            self.url = "mongodb+srv://Project:Kabali123$@cluster0.vs2jq.mongodb.net/myFirstDatabase?retryWrites=true&w=majority".format(
